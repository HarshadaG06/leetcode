...
public class maximumRunTimeOfNComputers {
    public long maxRunTime(int n, int[] batteries) {
        ...
        /*We increase the total running time using "extra" by increasing the run time of the 
        computer with the smallest battery*/
